...
@register_model('deeplab_v3_plus', 'DeeplabV3Plus')
class DeeplabV3Plus(ModelWrapper):
    ...
    # Arguments
        ...
        num_classes: number of desired classes. PASCAL VOC has 21 classes, Cityscapes has 19 classes.
        ...
        summary:  bool, optional
            If true a summary of the model will be printed to stdout. Defaults to False.
    ...
    # References
        - [keras-deeplab-v3-plus](https://github.com/bonlime/)
    ...
    def __init__(self, input_shape, num_classes, backbone='xception', OS=16, alpha=1.0,
                 model_weights=None, summary=False, optimizer=None, loss=None, **kwargs):

        model = build_deeplab(input_shape=input_shape, classes=num_classes,
                              backbone=backbone, OS=OS, alpha=alpha, activation='softmax')
...
def build_deeplab(input_tensor=None, input_shape=(512, 512, 3), classes=21, backbone='mobilenetv2',
    ...
    if backbone == 'xception':
        # rate = 6 (12)
        b1 = _SepConv_BN(x, 256, 'aspp1',
                         rate=atrous_rates[0], depth_activation=True, epsilon=1e-5)
        # rate = 12 (24)
        b2 = _SepConv_BN(x, 256, 'aspp2',
                         rate=atrous_rates[1], depth_activation=True, epsilon=1e-5)
        # rate = 18 (36)
        b3 = _SepConv_BN(x, 256, 'aspp3',
    ...
    if backbone == 'xception':
        ...
        x = _SepConv_BN(x, 256, 'decoder_conv0',
                        depth_activation=True, epsilon=1e-5)
        x = _SepConv_BN(x, 256, 'decoder_conv1',
                        depth_activation=True, epsilon=1e-5)
